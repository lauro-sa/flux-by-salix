  ...
  return (
    <td className="px-1 py-1.5 text-center">
      <button
        ...
        onClick={onChange}
        className={[
          'inline-flex items-center justify-center size-7 rounded-boton border transition-all duration-150 cursor-pointer focus-visible:outline-2 focus-visible:outline-texto-marca focus-visible:-outline-offset-2',
          activo
