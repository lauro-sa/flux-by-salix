    ...
    <div className="flex flex-col" style={{ minWidth: 280 }}>
      ...
      <AnimatePresence>
        {programadoPendiente && (
          ...
          >
            <div
              className="rounded-card p-3 mb-2 flex flex-col gap-2"
              style={{
            ...
            >
              ...
              <button
                ...
                className="text-xs font-medium py-1.5 px-3 rounded-card transition-colors self-start"
                style={{
        ...
        {presets.map((preset) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-3 px-2.5 py-2.5 rounded-card transition-colors text-left hover:bg-superficie-hover"
              style={{ minHeight: 44 }}
            >
              <span
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  min={minimoFecha}
                  className="w-full px-3 py-2.5 rounded-card text-sm transition-colors outline-none"
                  style={{
    ...
    >
      {children || (
        <Tooltip contenido="Programar envío">
          <motion.button
            whileTap={{ scale: 0.9 }}
            className="p-2 rounded-card flex-shrink-0 transition-colors hover:bg-superficie-hover relative"
            style={{
