    ...
    >
      ...
      <AnimatePresence>
        {archivoSeleccionado && (
          ...
          >
            <div
              className="flex items-center gap-2 p-2 rounded-card relative"
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {OPCIONES_FIRMA.map((op) => {
                        ...
                        return (
                          <button
                            key={op.valor}
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-card text-xs transition-colors"
                            style={{
          ...
          <>
            ...
            {(tieneContenido || audioGrabado) && (
              ...
              <motion.button
                ...
                className="p-2 rounded-card flex-shrink-0 transition-colors"
                style={{
