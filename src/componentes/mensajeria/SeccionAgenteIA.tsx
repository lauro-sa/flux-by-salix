...
export default function SeccionAgenteIA() {
  ...
  return (
    <div className="space-y-5">
      {/* ═══ Header + toggle ═══ */}
      <div className="flex items-center justify-between p-4 rounded-card" style={estiloSeccion}>
    ...
    <>
      <div>
        ...
        <div
          ...
          className="w-full text-xs rounded-card px-3 py-2 cursor-pointer transition-colors group relative overflow-hidden"
          style={{
        ...
        <div className="p-4 rounded-card space-y-3" style={estiloSeccion}>
          ...
          <div className="space-y-2">
            {canales.map(canal => (
              <div
                key={canal.id}
                className="flex items-center gap-3 py-1.5 px-2 rounded-card cursor-pointer transition-colors"
                style={{
    ...
    <>
      ...
      <div className="p-4 rounded-card space-y-3" style={estiloSeccion}>
        ...
        {tipos.map((tipo, i) => (
          <div
            key={i}
            className="flex items-center justify-between py-2.5 px-3 rounded-card"
...
function TabCapacidades({ config, guardar }: TabProps) {
  ...
  return (
    <div className="p-4 rounded-card space-y-1" style={estiloSeccion}>
  ...
  return (
    <div className="p-4 rounded-card space-y-3" style={estiloSeccion}>
      ...
      {!resultado && (
        <>
          {/* Desde Flux */}
          <div className="p-3 rounded-card space-y-2" style={{ border: '1px solid var(--borde-sutil)' }}>
          ...
          <div className="p-3 rounded-card space-y-2" style={{ border: '1px solid var(--borde-sutil)' }}>
            ...
            <label
              className="flex items-center justify-center gap-2 p-3 rounded-card cursor-pointer transition-colors text-xs font-medium"
    ...
    <>
      <div className="p-4 rounded-card space-y-3" style={estiloSeccion}>
        ...
        {ejemplos.map((ej, i) => (
          <div
            key={i}
            className="p-3 rounded-card space-y-1.5"
            style={{ background: 'var(--superficie-hover)' }}
          >
            <div className="flex items-center justify-between">
    ...
    <>
      ...
      <div className="p-4 rounded-card space-y-3" style={estiloSeccion}>
        ...
        {entradas.map(entrada => (
          <div
            key={entrada.id}
            className="flex items-center justify-between py-2 px-2 rounded-card"
            style={{ background: 'var(--superficie-hover)' }}
          >
      ...
      <Modal abierto={modalImportarAbierto} onCerrar={() => setModalImportarAbierto(false)}>
        <div className="space-y-4 p-1">
          ...
          {/* Desde URL */}
          <div className="p-4 rounded-card space-y-3" style={{ border: '1px solid var(--borde-sutil)' }}>
            <div className="flex items-center gap-2">
...
function TabActividad() {
  ...
  const renderFilaLog = (log: LogAgenteIA) => (
    <div
      key={log.id}
      className="flex items-center justify-between py-2 px-2 rounded-card text-xs"
      style={{ background: 'var(--superficie-hover)' }}
    >
      <div className="flex items-center gap-2">
