...
export const en: Traducciones = {
  ...
  documentacion: {
    ...
    volver: 'Back',
    sin_doc_titulo: 'Documentation not available',
    sin_doc_descripcion: 'The documentation for this module is not available yet. If you need help, contact support.',
  },
  ...
  flujos: {
    ...
    modal_nuevo: {
      ...
      elegir_icono: 'Choose icon',
      icono_label: 'Icon',
      sugerencia_hint: 'We suggest an icon and color from the name; you can change them.',
      color_label: 'Color',
    ...
    editor: {
      ...
      panel: {
        ...
        completar_actividad: {
          tipo_id_label: 'Activity type',
          tipo_id_ayuda: 'Filter by type (recommended).',
          relacionada_label: 'Linked to',
          relacionada_ayuda: 'Closes only activities linked to the selected entity.',
          relacionada_ninguna: 'No link',
          entidad_contacto: 'Contact',
          relacionada_entidad_id_label: 'Linked entity ID',
          relacionada_entidad_id_placeholder: '{{entidad.id}}',
          contacto_label: 'Linked contact (optional)',
          contacto_placeholder: '{{contacto.id}}',
          asignado_label: 'Assigned to (optional)',
          estado_label: 'Current activity state',
          estado_pendiente: 'Pending',
          estado_completada: 'Completed',
          estado_cancelada: 'Cancelled',
          si_multiple_label: 'If multiple match',
          si_multiple_mas_antigua: 'Oldest',
          si_multiple_mas_reciente: 'Most recent',
          si_multiple_todas: 'All',
          si_multiple_fallar: 'Fail',
          si_no_encuentra_label: 'If none match',
          si_no_encuentra_continuar: 'Continue',
          si_no_encuentra_fallar: 'Fail',
          motivo_label: 'Reason (optional)',
          motivo_placeholder: 'Auto-close on state change',
          motivo_ayuda: 'Shown in the chatter of closed activities (e.g. "Completed by flow «X». Reason: «...»").',
          plantillas_titulo: 'Start with a template',
          plantillas_ayuda: 'Tap one to auto-fill the criterion. You can adjust it afterwards.',
          plantillas_aplicada: 'Template applied — fill in the activity type if the template requires it.',
          error_filtro_positivo: 'You need to set an activity type or a linked entity. Filtering only by assignee or contact may close activities from other flows.',
          plantilla: {
            cerrar_al_enviar_presupuesto: {
              titulo: 'Close quote activities when sent',
              descripcion: 'Links to the triggering quote. Closes all linked activities. If none, continues.',
            },
            cerrar_al_completar_visita: {
              titulo: 'Close visit activities when completed',
              descripcion: 'Links to the triggering visit. Closes all linked activities. If none, continues.',
            },
            cerrar_mas_antigua_del_contacto: {
              titulo: 'Close the oldest for the contact (by type)',
              descripcion: 'Filters by the flow contact. Pick an activity type. Closes only the oldest match.',
            },
            cerrar_todas_mias_del_tipo: {
              titulo: 'Close all my activities (by type)',
              descripcion: 'Filters by the flow actor. Pick an activity type. Closes all matches.',
            },
          },
        },
