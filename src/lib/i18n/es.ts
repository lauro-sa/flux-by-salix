  ...
  flujos: {
    ...
    editor: {
      ...
      panel: {
        ...
        completar_actividad: {
          tipo_id_label: 'Tipo de actividad',
          tipo_id_ayuda: 'Filtrá por tipo (recomendado).',
          relacionada_label: 'Vinculada a',
          relacionada_ayuda: 'Cierra solo actividades vinculadas a la entidad seleccionada.',
          relacionada_ninguna: 'Sin vínculo',
          entidad_contacto: 'Contacto',
          relacionada_entidad_id_label: 'ID de la entidad vinculada',
          relacionada_entidad_id_placeholder: '{{entidad.id}}',
          contacto_label: 'Contacto vinculado (opcional)',
          contacto_placeholder: '{{contacto.id}}',
          asignado_label: 'Asignado a (opcional)',
          estado_label: 'Estado actual de la actividad',
          estado_pendiente: 'Pendiente',
          estado_completada: 'Completada',
          estado_cancelada: 'Cancelada',
          si_multiple_label: 'Si hay varias coincidencias',
          si_multiple_mas_antigua: 'Más antigua',
          si_multiple_mas_reciente: 'Más reciente',
          si_multiple_todas: 'Todas',
          si_multiple_fallar: 'Fallar',
          si_no_encuentra_label: 'Si no encuentra ninguna',
          si_no_encuentra_continuar: 'Continuar',
          si_no_encuentra_fallar: 'Fallar',
          motivo_label: 'Motivo (opcional)',
          motivo_placeholder: 'Auto-cierre al avanzar de estado',
          motivo_ayuda: 'Aparece en el chatter de las actividades cerradas (ej: "Completada por flujo «X». Motivo: «...»").',
          plantillas_titulo: 'Empezá con una plantilla',
          plantillas_ayuda: 'Tocá una para auto-rellenar el criterio. Después podés ajustarlo.',
          plantillas_aplicada: 'Plantilla aplicada — completá el tipo de actividad si la plantilla lo pide.',
          error_filtro_positivo: 'Necesitás definir tipo de actividad o entidad vinculada. Filtrar solo por asignado o contacto puede cerrar actividades de otros flujos.',
          plantilla: {
            cerrar_al_enviar_presupuesto: {
              titulo: 'Cerrar actividades del presupuesto al enviarlo',
              descripcion: 'Vincula al presupuesto disparador. Cierra todas las actividades vinculadas. Si no hay ninguna, sigue.',
            },
            cerrar_al_completar_visita: {
              titulo: 'Cerrar actividades de la visita al completarla',
              descripcion: 'Vincula a la visita disparadora. Cierra todas las actividades vinculadas. Si no hay ninguna, sigue.',
            },
            cerrar_mas_antigua_del_contacto: {
              titulo: 'Cerrar la más antigua del contacto (por tipo)',
              descripcion: 'Filtra por contacto del flujo. Elegí el tipo de actividad. Cierra solo la más antigua.',
            },
            cerrar_todas_mias_del_tipo: {
              titulo: 'Cerrar todas mis actividades (por tipo)',
              descripcion: 'Filtra por el actor del flujo. Elegí el tipo de actividad. Cierra todas las que matcheen.',
            },
          },
        },
