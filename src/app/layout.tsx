  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <head>
        ...
        {/* Anti-FOUC: detectar tema ANTES de hidratar para evitar flash.
            Lee flux_preferencias de localStorage → extrae .tema → aplica data-tema al html.
            Va en <head> como <script> plano (no next/script) porque
            <Script strategy="beforeInteractive"> dentro del body emite warning
            en Next 16 y no se ejecuta en cliente. */}
        <script
