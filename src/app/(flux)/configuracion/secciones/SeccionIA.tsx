...
const DEFAULTS: ConfigIA = {
  ...
  api_key_google: '',
  api_key_xai: '',
  modelo_anthropic: 'claude-haiku-4-5-20251001',
...
const HERRAMIENTAS_COPILOTO = [
  ...
  { id: 'consultar_vinculaciones_contacto', nombre: 'Ver contactos vinculados', grupo: 'Contactos' },
  { id: 'vincular_contactos', nombre: 'Vincular/desvincular contactos', grupo: 'Contactos' },
  ...
  { id: 'consultar_movimientos_nomina', nombre: 'Ver adelantos y descuentos', grupo: 'Nómina' },
  { id: 'crear_movimiento_nomina', nombre: 'Crear adelanto o descuento', grupo: 'Nómina' },
  { id: 'modificar_movimiento_nomina', nombre: 'Modificar adelanto o descuento', grupo: 'Nómina' },
  { id: 'eliminar_movimiento_nomina', nombre: 'Cancelar adelanto o descuento', grupo: 'Nómina' },
