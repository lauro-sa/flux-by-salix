...
/**
 * Contenido interactivo de la papelera — Client Component.
 * Recibe datosIniciales del Server Component para renderizar instantáneamente.
...
export default function ContenidoPapelera({ datosIniciales }: Props) {
  ...
  // React Query con datos iniciales del servidor — sin loading en primera carga
