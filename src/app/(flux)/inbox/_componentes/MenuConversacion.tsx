        ...
        .map((item) => (
          <div key={item.clave}>
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 text-sm transition-colors rounded-lg hover:bg-[var(--superficie-hover)] cursor-pointer"
              style={{
          ...
          <>
            ...
            {!esMobile && (
              <motion.div
                ...
                className="rounded-xl border border-borde-sutil shadow-elevada overflow-hidden p-1"
                style={{
            ...
            <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
              ...
              >
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-borde-sutil shrink-0">
                  ...
                  <button
                    onClick={() => { setModalFijarUsuario(false); setBusquedaMiembros(''); setMiembrosSeleccionados(new Set()) }}
                    className="flex items-center justify-center size-7 rounded-lg hover:bg-[var(--superficie-hover)] transition-colors cursor-pointer"
                    ...
                    miembrosFiltrados.map(m => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg transition-colors hover:bg-[var(--superficie-hover)] cursor-pointer"
                          style={{
