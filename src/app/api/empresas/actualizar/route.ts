...
export async function PATCH(request: NextRequest) {
  try {
    ...
    // Campos permitidos
    const permitidos = ['nombre', 'descripcion', 'slug', 'logo_url', 'pais', 'paises', 'color_marca', 'color_secundario', 'color_terciario', 'ubicacion', 'direccion', 'pagina_web', 'correo', 'telefono', 'moneda', 'formato_fecha', 'formato_hora', 'dia_inicio_semana', 'zona_horaria', 'datos_fiscales', 'datos_bancarios', 'horario_notificaciones']
