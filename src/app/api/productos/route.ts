...
export async function POST(request: NextRequest) {
  try {
    ...
    const nuevoProducto = {
      ...
      ubicacion_deposito: body.ubicacion_deposito || null,
      dimensiones: body.dimensiones || null,
      proveedor_principal: body.proveedor_principal || null,
      stock_actual: body.stock_actual ?? 0,
      stock_minimo: body.stock_minimo ?? 0,
      stock_maximo: body.stock_maximo ?? 0,
      punto_reorden: body.punto_reorden ?? 0,
      alerta_stock_bajo: body.alerta_stock_bajo ?? false,
