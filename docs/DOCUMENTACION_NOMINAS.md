...
## 🛑 Terminar el contrato de un empleado (renuncia, despido, etc.)

Cuando un empleado deja de trabajar, **no lo borres**: terminás su contrato. Así queda registro completo en el historial y los recibos pasados no se tocan.

### Cómo hacerlo

1. Abrí la ficha del empleado.
2. En la pestaña **"Contrato vigente"**, click en **"Terminar"**.
3. Elegí la **fecha de baja** (default: hoy), el **motivo** (renuncia, despido sin causa, despido con causa, fin de plazo, mutuo acuerdo, abandono, jubilación, fallecimiento, otro) y opcionalmente una **nota** (obligatoria si elegís "Otro").

### Qué pasa después

- El estado del contrato cambia a **"Terminado"** y se muestra el motivo en rojo en la ficha.
- El empleado **deja de aparecer en Liquidaciones** desde el período siguiente a la fecha de baja.
- Si la baja fue **dentro del período actual**, el recibo se calcula prorrateado y aparece una advertencia para que revises el monto.
- Sigue apareciendo en la pestaña **Empleados** si filtrás por "Terminados" o "Todos".
- Los pagos ya registrados **no cambian** — quedan congelados con el contrato que tenían al momento del pago.

### Cambié de idea o me equivoqué de fecha

Por ahora no hay "deshacer" desde la UI: si necesitás revertir, creá un **contrato nuevo** desde la misma pestaña. Eso reactiva al empleado con las condiciones que pongas (las viejas no se restauran automáticamente).

### Si querés ver los empleados terminados en Liquidaciones

Por default no aparecen. Si tu empresa los quiere ver en gris con $0 (útil para auditoría o cierre de mes), activá la opción **"Mostrar empleados con contrato terminado en Liquidaciones"** en *Nóminas → Configuración → Plantillas de envío*.

---

## 🏖️ Licencias y pausas

Cuando un empleado tiene un período donde **no trabaja pero el contrato sigue vigente** (licencia médica, maternidad, suspensión disciplinaria, vacaciones extendidas, etc.), lo registrás como **licencia**.

### Cómo cargar una licencia

1. Ficha del empleado → pestaña **"Licencias"**.
2. **"Nueva licencia"**.
3. Elegí:
   - **Tipo**: médica, maternidad, paternidad, estudio, examen, duelo, matrimonio, mudanza, vacaciones, suspensión disciplinaria, suspensión económica u "otro" (con nota obligatoria).
   - **Fecha de inicio** (obligatoria) y **fecha de fin** (opcional — dejala vacía si todavía no sabés cuándo termina).
   - **Con goce de sueldo**: si está activado, los días pagan normal. Si no, el motor los descuenta del recibo.
   - **Notas**: número de certificado médico, motivo, etc.

### Cómo afecta el recibo

- **Con goce**: la licencia aparece informativa en el desglose, pero el monto no cambia. Útil para vacaciones, licencias médicas cortas, etc.
- **Sin goce**: el motor descuenta automáticamente la parte proporcional del período. Por ejemplo, si un empleado mensual gana $400.000 y tuvo 10 días de suspensión sin goce, el descuento es $400.000 ÷ 30 × 10 = $133.333.

### Licencias abiertas

Si todavía no sabés cuándo vuelve el empleado (licencia médica indeterminada, por ejemplo), dejá **"fecha de fin"** vacía. Cuando vuelva, abrí la licencia y clickeá **"Cerrar"** — eso le pone la fecha de fin de hoy.

### No se pueden superponer

Una persona no puede tener dos licencias activas al mismo tiempo para el mismo contrato. Si querés cambiar una licencia abierta por otra (ej. de médica a maternidad), primero cerrá la primera y después creá la segunda.
...
*Guía del módulo Nóminas — Flux by Salix. Última actualización: 2026-05-15.*
